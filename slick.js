    ...
    ((a =
        ...
        function (a, d) {
            ...
            (_.defaults = {
                ...
                customPaging: function (b, a) {
                    return $('<button type="button" data-role="none" role="button" tabindex="0" />').text(a + 1);
                },
                dots: !1,
        ...
        (a.prototype.buildDots = function () {
            ...
            if (!0 === _.options.dots && _.slideCount > _.options.slidesToShow) {
                ...
                (_.$dots = b.appendTo(_.options.appendDots)), _.$dots.find("li").first().addClass("slick-active").attr("aria-hidden", "false");
            }
        }),
        ...
        (a.prototype.buildRows = function () {
            var a, b, c, e, g, d, f;
            if (((e = document.createDocumentFragment()), (d = this.$slider.children()), this.options.rows > 1)) {
        ...
        (a.prototype.cleanUpEvents = function () {
            this.options.dots && null !== this.$dots && $("li", this.$dots).off("click.slick", this.changeSlide).off("mouseenter.slick", $.proxy(this.interrupt, this, !0)).off("mouseleave.slick", $.proxy(this.interrupt, this, !1)),
        ...
        (a.prototype.cleanUpRows = function () {
            var a;
            this.options.rows > 1 && ((a = this.$slides.children().children()).removeAttr("style"), this.$slider.empty().append(a));
        }),
        ...
        (a.prototype.focusHandler = function () {
            var _ = this;
            _.$slider.off("focus.slick blur.slick").on("focus.slick blur.slick", "*:not(.slick-arrow)", function (a) {
                a.stopImmediatePropagation();
                var b = $(this);
                setTimeout(function () {
                    _.options.pauseOnFocus && ((_.focussed = b.is(":focus")), _.autoPlay());
                }, 0);
            });
        }),
        ...
        (a.prototype.getLeft = function (a) {
            ...
            return (
                ...
                !0 === _.options.infinite
                    ? (_.slideCount > _.options.slidesToShow && ((_.slideOffset = -(_.slideWidth * _.options.slidesToShow * 1)), (d = -(c * _.options.slidesToShow * 1))),
        ...
        (a.prototype.getSlideCount = function () {
            var a,
                b,
                _ = this;
            return ((b = !0 === _.options.centerMode ? _.slideWidth * Math.floor(_.options.slidesToShow / 2) : 0), !0 === _.options.swipeToSlide)
                ? (_.$slideTrack.find(".slick-slide").each(function (d, c) {
                      if (c.offsetLeft - b + $(c).outerWidth() / 2 > -1 * _.swipeLeft) return (a = c), !1;
                  }),
        ...
        (a.prototype.initADA = function () {
            ...
            _.$slides.add(_.$slideTrack.find(".slick-cloned")).attr({ "aria-hidden": "true", tabindex: "-1" }).find("a, input, button, select").attr({ tabindex: "-1" }),
                ...
                _.$slides.not(_.$slideTrack.find(".slick-cloned")).each(function (a) {
                    $(this).attr({ role: "option", "aria-describedby": "slick-slide" + _.instanceUid + a });
                }),
                null !== _.$dots &&
                    _.$dots
                        .attr("role", "tablist")
                        .find("li")
                        .each(function (a) {
                            $(this).attr({ role: "presentation", "aria-selected": "false", "aria-controls": "navigation" + _.instanceUid + a, id: "slick-slide" + _.instanceUid + a });
                        })
                        .first()
        ...
        (a.prototype.initDotEvents = function () {
            !0 === this.options.dots && this.slideCount > this.options.slidesToShow && $("li", this.$dots).on("click.slick", { message: "index" }, this.changeSlide),
                !0 === this.options.dots && !0 === this.options.pauseOnDotsHover && $("li", this.$dots).on("mouseenter.slick", $.proxy(this.interrupt, this, !0)).on("mouseleave.slick", $.proxy(this.interrupt, this, !1));
        }),
        ...
        (a.prototype.lazyLoad = function () {
            ...
            !0 === _.options.centerMode
                ...
                _.slideCount <= _.options.slidesToShow
                    ? c(_.$slider.find(".slick-slide"))
                    : _.currentSlide >= _.slideCount - _.options.slidesToShow
                    ? c(_.$slider.find(".slick-cloned").slice(0, _.options.slidesToShow))
                    : 0 === _.currentSlide && c(_.$slider.find(".slick-cloned").slice(-1 * _.options.slidesToShow));
        }),
        ...
        (a.prototype.postSlide = function (a) {
            var _ = this;
            _.unslicked || (_.$slider.trigger("afterChange", [_, a]), (_.animating = !1), _.setPosition(), (_.swipeLeft = null), _.options.autoplay && _.autoPlay(), !0 === _.options.accessibility && _.initADA());
        }),
        ...
        (a.prototype.progressiveLazyLoad = function (b) {
            b = b || 1;
            var e,
                c,
                a,
                _ = this,
                d = $("img[data-lazy]", _.$slider);
            d.length
                ? ((c = (e = d.first()).attr("data-lazy")),
                  ((a = document.createElement("img")).onload = function () {
                      e.attr("src", c).removeAttr("data-lazy").removeClass("slick-loading"), !0 === _.options.adaptiveHeight && _.setPosition(), _.$slider.trigger("lazyLoaded", [_, e, c]), _.progressiveLazyLoad();
                  }),
                  (a.onerror = function () {
                      b < 3
                          ? setTimeout(function () {
                                _.progressiveLazyLoad(b + 1);
                            }, 500)
                          : (e.removeAttr("data-lazy").removeClass("slick-loading").addClass("slick-lazyload-error"), _.$slider.trigger("lazyLoadError", [_, e, c]), _.progressiveLazyLoad());
                  }),
                  (a.src = c))
        ...
        (a.prototype.registerBreakpoints = function () {
            ...
            if ("array" === $.type(b) && b.length) {
                for (c in ((_.respondTo = _.options.respondTo || "window"), b))
                    if (((a = _.breakpoints.length - 1), (d = b[c].breakpoint), b.hasOwnProperty(c))) {
                        for (; a >= 0; ) _.breakpoints[a] && _.breakpoints[a] === d && _.breakpoints.splice(a, 1), a--;
        ...
        (a.prototype.setSlideClasses = function (a) {
            var d, b, c, e;
            (b = this.$slider.find(".slick-slide").removeClass("slick-active slick-center slick-current").attr("aria-hidden", "true")),
        ...
        (a.prototype.selectHandler = function (b) {
            ...
            if ((a || (a = 0), this.slideCount <= this.options.slidesToShow)) {
                this.setSlideClasses(a), this.asNavFor(a);
                return;
            }
            this.slideHandler(a);
        }),
        (a.prototype.slideHandler = function (b, e, f) {
            var a,
                ...
                i = null,
                _ = this;
            if (((e = e || !1), (!0 !== _.animating || !0 !== _.options.waitForAnimate) && (!0 !== _.options.fade || _.currentSlide !== b) && !(_.slideCount <= _.options.slidesToShow))) {
                if (
                    (!1 === e && _.asNavFor(b),
                    (a = b),
                    (i = _.getLeft(a)),
        ...
        (a.prototype.swipeMove = function (b) {
            ...
            return (
                ...
                !!_.dragging &&
                    ...
                    "vertical" === f)
                        ? void 0
                        : (void 0 !== b.originalEvent && _.touchObject.swipeLength > 4 && b.preventDefault(),
